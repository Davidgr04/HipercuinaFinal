      ...
      <div class="form-box">
        ...
        <div class="column-21">
            <select name="Proveedor" id="favoriteOnly" class="optionss">
                      <option disabled selected value="">Proveedor preferido:</option>
            ...
            <div class="inputbox">
                ...
                <label for="">Espacio(baño, cocina, sala...)</label>
            </div>
            <div class="inputbox">
              <input type="number" name="NumTel" id="inputField" required>
              <label for="">NºTelefono</label>
            </div>
        </div>
        ...
        <a href="./Pagina_inicial.php">Pagina principal</a>
        </div>
      </div>
    </section>
</form>
